...
n[W.expando]=void 0}n[G.expando]&&(n[G.expando]=void 0)}}}),g.fn.extend({detach:function(e){return je(this,e,!0)},remove:function(e){return je(this,e)},text:function(e){return H(this,function(e){return void 0===e?g.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return Pe(this,arguments,function(e){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||Te(this,e).appendChild(e)})},prepend:function(){return Pe(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=Te(this,e)
...
var n=Le(this,e.apply(this,arguments))
return n.type="optimized-trusting-append",n}return Ie(t,e),t.prototype.normalize=function(e){return(0,n.map)(e,Ue)},t.prototype.insert=function(e,t,n){return Pe(e,t,n)},t.prototype.updateWith=function(e,t,n,r,i){return new Ye(n,r,i)},t}(ze),Ye=function(e){function t(){Fe(this,t)
var n=Le(this,e.apply(this,arguments))
...
var n}function Un(e,t){return Zt(e,t)?new Qn(t):new Hn(t)}var Hn=function(){function e(t){Fn(this,e),this.attr=t}return e.prototype.setAttribute=function(e,t,n,r){var i=e.getAppendOperations(),o=function(e){if(!1===e||void 0===e||null===e)return null
if(!0===e)return""
...
return void 0!==n?n.watchedEvents():[]},e.isNone=rt,e.isEmpty=it,e.isBlank=ot,e.isPresent=function(e){return!ot(e)},e.run=at,e.ObserverSet=T,e.beginPropertyChanges=z,e.changeProperties=W,e.endPropertyChanges=V,e.overrideChains=H,e.propertyDidChange=I,e.propertyWillChange=L,e.PROPERTY_DID_CHANGE=j,e.defineProperty=Y,e.Descriptor=Q,e._hasCachedComputedProperties=function(){$=!0},e.watchKey=X,e.unwatchKey=J,e.ChainNode=le,e.finishChains=function(e){var t=e.readableChainWatchers()
...
var n=Math.round
e.default=Ember.Component.extend({layout:t.default,classNames:["infinite-scroller"],classNameBindings:["isLoading"],debug:!1,_infiniteScroller:Ember.inject.service("-infinite-scroller"),didInsertElement:function(){this._super.apply(this,arguments),this.set("_scrollHandler",Ember.run.bind(this,"_scroll")),this._listener().addEventListener("scroll",this.get("_scrollHandler"))},willDestroyElement:function(){this._super.apply(this,arguments),this._listener().removeEventListener("scroll",this.get("_scrollHandler")),Ember.run.cancel(this.get("_scrollDebounceId"))},_scroll:function(e){this.set("_scrollDebounceId",Ember.run.debounce(this,"_debouncedScroll",e,this._scrollDebounce()))},_debouncedScroll:function(){this.get("debug")&&this._debug(),this._shouldLoadMore()&&this._loadMore()},_listener:function(){return this.get("use-document")?this.get("_infiniteScroller.document"):this.get("element")},_scrollDebounce:function(){return this.get("scroll-debounce")||100},_scrollerHeight:function(){return this.get("use-document")?this.get("_infiniteScroller.documentElement.clientHeight"):this.get("element.offsetHeight")},_scrollableHeight:function(){return this.get("use-document")?this.get("_infiniteScroller.documentElement.offsetHeight"):this.get("element.scrollHeight")},_scrollTop:function(){return this.get("use-document")?this.get("_infiniteScroller.documentElement.scrollTop"):this.get("element.scrollTop")},_scrollerBottom:function(){return this._scrollableHeight()-this._scrollerHeight()},_scrollPercentage:function(){return n(this._scrollTop()/this._scrollerBottom()*100)},_triggerAt:function(){return parseInt(this.get("trigger-at")||"100%",10)},_reachedBottom:function(){return this._scrollPercentage()>=this._triggerAt()},_shouldLoadMore:function(){return this._reachedBottom()&&!this.get("isLoading")},_debug:function(){console.table([{"scroller height":this._scrollerHeight(),"scrollable height":this._scrollableHeight(),"scroll top":this._scrollTop(),"scroll debounce":this._scrollDebounce(),"trigger at":this._triggerAt(),"scroll percentage":this._scrollPercentage(),"reached bottom":this._reachedBottom(),"should load more":this._shouldLoadMore()}])},_loadMore:function(){this.set("error",null),this.set("isLoading",!0),Ember.RSVP.resolve(this.get("on-load-more")()).catch(Ember.run.bind(this,"_loadError")).finally(Ember.run.bind(this,"_loadFinished"))},_loadError:function(e){this.get("isDestroyed")||this.set("error",e)},_loadFinished:function(){this.get("isDestroyed")||this.set("isLoading",!1)},actions:{loadMore:function(){this._loadMore()}}})}),define("@zestia/ember-simple-infinite-scroller/services/-infinite-scroller",["exports"],function(e){"use strict"
